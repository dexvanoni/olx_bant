...
<head>
    ...
    <title>Teste Completo de Resgate</title>
    <link href="https://cdn.jsdelivr.net/npm/bootstrap@5.3.0/dist/css/bootstrap.min.css" rel="stylesheet">
    <link href="https://cdn.jsdelivr.net/npm/bootstrap-icons@1.10.0/font/bootstrap-icons.css" rel="stylesheet">
</head>
<body>
    <div class="container mt-5">
        <h1>Teste Completo de Resgate</h1>
        ...
        <div class="mt-4">
            <h3>Teste de Alertas</h3>
            <button type="button" class="btn btn-success" onclick="testeAlert('success', 'Resgate realizado com sucesso!')">
                Teste Sucesso
            </button>
            <button type="button" class="btn btn-danger" onclick="testeAlert('danger', 'Erro no resgate!')">
                Teste Erro
            </button>
            <button type="button" class="btn btn-warning" onclick="testeAlert('warning', 'Aviso importante!')">
                Teste Aviso
            </button>
        </div>
    </div>
